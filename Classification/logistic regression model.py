...
print(result)
print("Time in logistic regression:",end-start)
...
SVM= 71.66437700345532
LogisticRegression = 73.93946963073977
DecisionTree=95.12301735981017
acc = [  SVM , LogisticRegression,DecisionTree]
New_Colors = ['pink','palevioletred','mediumvioletred']
