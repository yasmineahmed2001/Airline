...
X=data.iloc[:,0:15]
Y=data['price2']
X_train, X_test, y_train, y_test = train_test_split(X, Y, test_size = 0.40,shuffle=False,random_state=10)
...
print('Mean Square Error to polynomial regression', metrics.mean_squared_error(y_test, prediction))
